package com.hztech.webapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("webappdemo");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("webappdemo");
        ...
        config.getMapConfigs().put("com.hztech.webapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
